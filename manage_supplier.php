    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-12 form-group form-inline">
          ...
          <input type="text" style="width:50%" class="form-control" id="" placeholder="Nhập tên nhóm hệ thống" onkeyup="searchSupplier(this.value); ">
          &emsp;
          <select id="user_status" class="form-control" onchange="searchTeamSys(this.value)" ;>

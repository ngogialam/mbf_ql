...
?>
  <div class="row">
    <div class="row col col-md-12">
      <div id="admin_acknowledgement" class="col-md-12 h5 text-success font-weight-bold text-center" style="font-family: sans-serif;">
        <?php
        echo $mess;
        ?>
      </div>
      ...
      <div class="row col col-md-12">
        <div class="col col-md-12 form-group">
          ...
          <input id="id_sys" type="text" class="form-control" value="<?php echo $id_sys; ?>" placeholder="id_sys" onkeyup="validateName(this.value, 'id_error');" disabled>
      ...
      <div class="row col col-md-12" style="flex-direction: row-reverse;">
        ...
        <div class="col col-md-12 form-group">
          ...
          <input id="name_team_sys" type="text" class="form-control" value="<?php echo $team_sys; ?>" placeholder="name_team_sys" onkeyup="validateName(this.value, 'name_team_sys_error');" disabled>
      ...
      <div class="row col col-md-12">
        <div class="col col-md-12 form-group">
          ...
          <input id="first_number" type="number" class="form-control" value="<?php echo $first_number; ?>" placeholder="first_number" onkeyup="validateName(this.value, 'first_number_error');" disabled>
          <code class="text-danger small font-weight-bold float-right mb-2" id="first_number_error" style="display: none;"></code>
        </div>
      </div>
      <div class="row col col-md-12">
        <?php
        ...
        <div class="col col-md-12 form-group">
          ...
          <input id="name_team_sys" type="text" class="form-control" value="<?php echo $name_unit_sys; ?>" placeholder="name_team_sys" onkeyup="validateName(this.value, 'name_team_sys_error');" disabled>
        </div>
      </div>
      <div class="row col col-md-12">
        <?php
        ...
        <div class="col col-md-12 form-group">
          ...
          <input id="describe_sys" type="text" class="form-control" value="<?php echo $name_unit_user; ?>" placeholder="describe_sys" onkeyup="validateName(this.value, 'describe_sys_error');" disabled>
        </div>
      </div>
      <div class="row col col-md-12">
        <div class="col col-md-12 form-group">
          ...
          <input id="manager_user" type="text" class="form-control" value="<?php echo $name_user_manager; ?>" placeholder="manager_user" onkeyup="validateName(this.value, 'describe_sys_error');" disabled>
          <code class="text-danger small font-weight-bold float-right mb-2" id="describe_sys_error" style="display: none;"></code>
        </div>
      </div>
      <div class="row col col-md-12">
        <div class="col col-md-12 form-group">
          <label for="name_team_sys">Mô tả hệ thống :</label>
          <input id="describe_sys" type="text" class="form-control" value="<?php echo $describe_sys; ?>" placeholder="describe_sys" onkeyup="validateName(this.value, 'describe_sys_error');" disabled>
          <code class="text-danger small font-weight-bold float-right mb-2" id="describe_sys_error" style="display: none;"></code>
        </div>
      </div>
      <div class="row col col-md-12">
        <div class="col col-md-12 form-group">
          ...
          <input type="text" id="document_sys" class="form-control" value="<?php echo $document_sys; ?>" placeholder="" onkeyup="validateName(this.value, 'document_sys_error');" disabled>
          <code class="text-danger small font-weight-bold float-right mb-2" id="document_sys_error" style="display: none;"></code>
        </div>
      </div>
      <div class="row col col-md-12">
        <div class="col col-md-12 form-group">
          <label for="name_team_sys">Server hệ thống :</label>
          <input id="server_sys" type="text" class="form-control" value="<?php echo $server_sys; ?>" placeholder="server_sys" onkeyup="validateName(this.value, 'server_sys_error');" disabled>
          <code class="text-danger small font-weight-bold float-right mb-2" id="server_sys_error" style="display: none;"></code>
        </div>
      </div>
      <div class="row col col-md-12">
        <div class="col col-md-12 form-group">
          <label for="name_team_sys">Ip hệ thống :</label>
          <input id="ip_sys" type="number" class="form-control" value="<?php echo $ip_sys; ?>" placeholder="ip_sys" onkeyup="validateName(this.value, 'username_error');" disabled>
          <code class="text-danger small font-weight-bold float-right mb-2" id="ip_sys_error" style="display: none;"></code>
        </div>
      </div>
      <div class="row col col-md-12">
        <div class="col col-md-12 form-group">
          <label for="name_team_sys">Cấu hình hệ thống :</label>
          <input id="config_sys" type="text" class="form-control" value="<?php echo $config_sys; ?>" placeholder="config_sys" onkeyup="validateName(this.value, 'config_sys_error');" disabled>
          <code class="text-danger small font-weight-bold float-right mb-2" id="config_sys_error" style="display: none;"></code>
        </div>
      </div>

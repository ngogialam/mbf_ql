...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Thêm đơn vị sử dụng</title>
    ...
    <div id="add_new_supplier_model">
      <div class="modal-dialog">
      	<div class="modal-content">
            ...
            <div class="font-weight-bold">Thêm đơn vị sử dụng</div>
    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('shopping-bag', 'Thêm đơn vị sử dụng', 'Thêm mới đơn vị');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          <div class="row col col-md-6">
            <?php
              // form content
              require "sections/add_new_unit_user.html";
            ?>
          </div>
        </div>
